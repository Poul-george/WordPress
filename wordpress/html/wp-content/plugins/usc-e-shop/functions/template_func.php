...
function usces_password_policy_message($out = ''){
	...
	if ($usces_options['system']['member_pass_rule_digit']) {
		$rules[] = __( "numeric character", 'usces' );
	}

	if ($usces_options['system']['member_pass_rule_lowercase']) {
		$rules[] = __( "lower-case alphabetics", 'usces' );
	}

	if ($usces_options['system']['member_pass_rule_upercase']) {
		$rules[] = __( "upper-case alphabetics", 'usces' );
	}

	if ($usces_options['system']['member_pass_rule_symbol']) {
